...
var packageName = 'webix:skin-glamour';  // https://atmospherejs.com/webix/skin-glamour
...
Package.describe({
  name: packageName,
  summary: 'Glamour skin for Webix UI',
  version: version,
  git: 'https://github.com/MeteorPackaging/webix-skin-glamour',
...
Package.onUse(function (api) {
  ...
  api.addFiles(['webix/codebase/skins/debug/glamour.css'], 'client');
